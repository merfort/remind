...
$endIf.taxCO2functionalForm4 
    ...
    if((cm_iterative_target_adj = 9) OR (cm_iterative_target_adj = 5), !! After cm_peakBudgYr, the global anchor trajectory increases linearly with fixed annual increase given by cm_taxCO2_IncAfterPeakBudgYr
