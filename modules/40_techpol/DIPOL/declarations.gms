...
*** deactivated
*** ---------------------------------------------------------------------------
$if %cm_DIPOL_addRealization% == "NDC2018" $include "./modules/40_techpol/NDC2018/declarations.gms"
$if %cm_DIPOL_addRealization% == "NPi2018" $include "./modules/40_techpol/NPi2018/declarations.gms"
