...
*** SOF ./modules/40_techpol/DIPOL/equations.gms
...
*** deactivated
*** ---------------------------------------------------------------------------
$if %cm_DIPOL_addRealization% == "NDC2018" $include "./modules/40_techpol/NDC2018/equations.gms"
$if %cm_DIPOL_addRealization% == "NPi2018" $include "./modules/40_techpol/NPi2018/equations.gms"
