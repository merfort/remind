...
$ifthen.oae_glo_limit not %cm_33_OAE_lim% == "off" !! a temporary solution to split global OAE limits based on regional GDP
    v33_emi.lo(t,regi,"oae") = - pm_gdp(t, regi) / sum(regi2, pm_gdp(t, regi2)) * s33_oae_glo_limit;
$endif.oae_glo_limit
