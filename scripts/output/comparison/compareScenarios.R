...
if (exists("outputdirs")) {
  ...
  listofruns <- list( 
    ...
    list(period = "long",  set = "Base-indSub_default-secSteelBound",  dirs = c("SSP2-Base_indSub_GDXcesfromBase_2020-02-27_09.54.13",  "SSP2-Base_secSteelBound_yearly_2020-03-02_10.34.14")),
